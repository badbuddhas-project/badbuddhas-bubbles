      ...
      content: (
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '100%' }}>
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 28, fontWeight: 500, color: C.white, marginBottom: 1 }}>вебинар с Дашей Чен</div>
            <div style={{ fontSize: 15, fontWeight: 500, color: C.text, marginBottom: 3 }}>Как себя перепридумать.</div>
            <div style={{ fontSize: 12, color: C.text2, marginBottom: 13 }}>b при чем здесь дыхание</div>
