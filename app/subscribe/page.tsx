      ...
      {step === 'payment' && (
        <div className="max-w-md mx-auto pt-4">
          <iframe
            ...
            style={{ minHeight: '600px', background: DARK_CARD, border: 'none', borderRadius: '16px' }}
            title="Оплата подписки"
          />
          <p className="text-xs text-white/40 mt-4 text-center">оплата через GetCourse · отмена в любой момент</p>
          <button
            onClick={handleAutoActivate}
            className="mt-4 text-sm text-center w-full bg-transparent border-none cursor-pointer"
            style={{ color: GREEN }}
          >
